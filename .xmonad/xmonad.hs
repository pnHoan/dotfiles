...
-- fore     = "#DEE3E0" -- NO USE
-- back     = "#282c34" -- NO USE
-- winType  = "#c678dd" --NO USE

normBord = "#808080" -- Commented 
focdBord = "#00ff00"
fore     = "#FFFFFF"
back     = "#000000"
-- winType  = "#c678dd"
...
myManageHook = composeAll . concat $
    ...
    myCFloats = ["Arandr", "Arcolinux-calamares-tool.py", "Archlinux-tweak-tool.py", "Arcolinux-welcome-app.py", "Galculator", "feh", "mpv", "Xfce4-terminal","org-microemu-app-Main"]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_F12), spawn $ "rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.xmonad/launcher/rofi/launcher.rasi" )
  , ((modMask, xK_b), spawn $ "brave" )
  , ((modMask .|. shiftMask, xK_b), spawn $ "microsoft-edge-stable" )
